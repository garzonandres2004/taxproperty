    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-300 text-sm font-medium">
        ...
        <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto mb-20">
          <div className="text-center">
            ...
            <div className="text-sm text-slate-400 uppercase tracking-wide">Properties Analyzed</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-white mb-1">90</div>
            <div className="text-sm text-slate-400 uppercase tracking-wide">Max Score</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-white mb-1">$5K</div>
            <div className="text-sm text-slate-400 uppercase tracking-wide">Min Bid Range</div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-slate-400">
                1
              </div>
              <h4 className="font-semibold mb-2">Import</h4>
              <p className="text-sm text-slate-400">County tax sale data imported automatically</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-slate-400">
                2
              ...
              <p className="text-sm text-slate-400">AGRC + zoning + Land Records scraped</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-slate-400">
                3
              ...
              <p className="text-sm text-slate-400">Risk-adjusted opportunity scores generated</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-slate-400">
                4
              ...
              <p className="text-sm text-slate-400">Executive reports for investor decisions</p>
            </div>
          </div>
        </div>

        {/* Demo CTA */}
        <div className="bg-blue-900/30 rounded-2xl p-12 text-center text-white">
        ...
        {/* Footer */}
        <div className="mt-20 pt-8 border-t border-slate-800 text-center text-slate-400 text-sm">
